...
+ (NSInteger)getDayNumbertoDay:(NSDate *)today beforDay:(NSDate *)beforday differType:(NSDateDifferType)differType
{
    ...
    if(differType==NSDateDifferTypeMonth){
        components=[calendar components:NSCalendarUnitDay fromDate:today toDate:beforday options:0];
    }else if(differType==NSDateDifferTypeDay){
        components=[calendar components:NSCalendarUnitMonth|NSCalendarUnitDay fromDate:today toDate:beforday options:0];
    }
